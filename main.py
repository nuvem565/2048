...
class Array:
    ...
    def __inform_or_generate_new_tile(self, previous_matrix):
        ...
        elif not arr.are_you_winning_son and any(any(cell >= 2048 for cell in row) for row in arr.matrix):
            # shows congrats message only once after the score exceeds 2048 points
            arr.are_you_winning_son = True
            print(
                " \033[1;31;40mCongrats! You scored".center(90) + "\n\n" +
                r"____/\\\\\\\\\_________/\\\\\\\_______________/\\\________/\\\\\\\\\____________" + "\n" +
                r"___/\\\///////\\\_____/\\\/////\\\___________/\\\\\______/\\\///////\\\_________" + "\n" +
                r"___\///______\//\\\___/\\\____\//\\\________/\\\/\\\_____\/\\\_____\/\\\________" + "\n" +
                r"______________/\\\/___\/\\\_____\/\\\______/\\\/\/\\\_____\///\\\\\\\\\/________" + "\n" +
                r"____________/\\\//_____\/\\\_____\/\\\____/\\\/__\/\\\______/\\\///////\\\______" + "\n" +
                r"__________/\\\//________\/\\\_____\/\\\__/\\\\\\\\\\\\\\\\__/\\\______\//\\\____" + "\n" +
                r"_________/\\\/___________\//\\\____/\\\__\///////////\\\//__\//\\\______/\\\____" + "\n" +
                r"_________/\\\\\\\\\\\\\\\__\///\\\\\\\/_____________\/\\\_____\///\\\\\\\\\/____" + "\n" +
                r"_________\///////////////_____\///////_______________\///________\/////////_____" + "\n" +
                "\033[1;37;40m")
            # adds a new tile allowing to play further
            self.__generate_new_tile()
        else:
            # adds a new tile as typical movement
            self.__generate_new_tile()
